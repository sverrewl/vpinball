                ...
                UINT cNames, LCID lcid, DISPID *rgDispId)
{
	...
	*rgDispId = DISPID_UNKNOWN;
	...
	if (!wcsicmp(*rgszNames, L"Drives")) {
		*rgDispId = 0x0000271a;
	}
	else if (!wcsicmp(*rgszNames, L"BuildPath")) {
		*rgDispId = 0x00002710;
	}
	else if (!wcsicmp(*rgszNames, L"GetDriveName")) {
		*rgDispId = 0x00002714;
	}
	else if (!wcsicmp(*rgszNames, L"GetParentFolderName")) {
		*rgDispId = 0x00002715;
	}
	else if (!wcsicmp(*rgszNames, L"GetFileName")) {
		*rgDispId = 0x00002716;
	}
	else if (!wcsicmp(*rgszNames, L"GetBaseName")) {
		*rgDispId = 0x00002717;
	}
	else if (!wcsicmp(*rgszNames, L"GetExtensionName")) {
		*rgDispId = 0x00002718;
	}
	else if (!wcsicmp(*rgszNames, L"GetAbsolutePathName")) {
		*rgDispId = 0x00002712;
	}
	else if (!wcsicmp(*rgszNames, L"GetTempName")) {
		*rgDispId = 0x00002713;
	}
	else if (!wcsicmp(*rgszNames, L"DriveExists")) {
		*rgDispId = 0x0000271f;
	}
	else if (!wcsicmp(*rgszNames, L"FileExists")) {
		*rgDispId = 0x00002720;
	}
	else if (!wcsicmp(*rgszNames, L"FolderExists")) {
		*rgDispId = 0x00002721;
	}
	else if (!wcsicmp(*rgszNames, L"GetDrive")) {
		*rgDispId = 0x0000271b;
	}
	else if (!wcsicmp(*rgszNames, L"GetFile")) {
		*rgDispId = 0x0000271c;
	}
	else if (!wcsicmp(*rgszNames, L"GetFolder")) {
		*rgDispId = 0x0000271d;
	}
	else if (!wcsicmp(*rgszNames, L"GetSpecialFolder")) {
		*rgDispId = 0x0000271e;
	}
	else if (!wcsicmp(*rgszNames, L"DeleteFile")) {
		*rgDispId = 0x000004b0;
	}
	else if (!wcsicmp(*rgszNames, L"DeleteFolder")) {
		*rgDispId = 0x000004b1;
	}
	else if (!wcsicmp(*rgszNames, L"MoveFile")) {
		*rgDispId = 0x000004b4;
	}
	else if (!wcsicmp(*rgszNames, L"MoveFolder")) {
		*rgDispId = 0x000004b5;
	}
	else if (!wcsicmp(*rgszNames, L"CopyFile")) {
		*rgDispId = 0x000004b2;
	}
	else if (!wcsicmp(*rgszNames, L"CopyFolder")) {
		*rgDispId = 0x000004b3;
	}
	else if (!wcsicmp(*rgszNames, L"CreateFolder")) {
		*rgDispId = 0x00000460;
	}
	else if (!wcsicmp(*rgszNames, L"CreateTextFile")) {
		*rgDispId = 0x0000044d;
	}
	else if (!wcsicmp(*rgszNames, L"OpenTextFile")) {
		*rgDispId = 0x0000044c;
	}
	else if (!wcsicmp(*rgszNames, L"GetStandardStream")) {
		*rgDispId = 0x00004e20;
	}
	else if (!wcsicmp(*rgszNames, L"GetFileVersion")) {
		*rgDispId = 0x00004e2a;
	}
	return (*rgDispId != DISPID_UNKNOWN) ? S_OK : DISP_E_UNKNOWNNAME;
#endif
}
                                      ...
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	switch(dispIdMember) {
		case 0x0000271a: {
			if (wFlags & DISPATCH_PROPERTYGET) {
				...
				hr = filesys_get_Drives(iface, (IDriveCollection**)&V_DISPATCH(pVarResult));
			}
			break;
		}
		case 0x00002710: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = filesys_BuildPath(iface, V_BSTR(&var0), V_BSTR(&var1), &V_BSTR(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x00002714: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetDriveName(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002715: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetParentFolderName(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002716: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetFileName(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002717: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetBaseName(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002718: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetExtensionName(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002712: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetAbsolutePathName(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002713: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetTempName(iface, &V_BSTR(pVarResult));
			}
			break;
		}
		case 0x0000271f: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = filesys_DriveExists(iface, V_BSTR(&var0), &V_BOOL(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002720: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BOOL;
				hr = filesys_FileExists(iface, V_BSTR(&var0), &V_BOOL(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x00002721: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BOOL;
				hr = filesys_FolderExists(iface, V_BSTR(&var0), &V_BOOL(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000271b: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_GetDrive(iface, V_BSTR(&var0), (IDrive**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000271c: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_GetFile(iface, V_BSTR(&var0), (IFile**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000271d: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_GetFolder(iface, V_BSTR(&var0), (IFolder**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000271e: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_GetSpecialFolder(iface, (SpecialFolderConst)V_I4(&var0), (IFolder**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x000004b0: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = filesys_DeleteFile(iface, V_BSTR(&var0), V_BOOL(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000004b1: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_BOOL(&var1) = 0;
				VariantChangeType(&var1, (index > 0) ? &pDispParams->rgvarg[--index] : &var1, 0, VT_BOOL);
				hr = filesys_DeleteFolder(iface, V_BSTR(&var0), V_BOOL(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000004b4: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = filesys_MoveFile(iface, V_BSTR(&var0), V_BSTR(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000004b5: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(&var1) = VT_EMPTY;
				VariantChangeType(&var1, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				hr = filesys_MoveFolder(iface, V_BSTR(&var0), V_BSTR(&var1));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x000004b2: {
			if (wFlags & DISPATCH_METHOD) {
				...
				hr = filesys_CopyFile(iface, V_BSTR(&var0), V_BSTR(&var1), V_BOOL(&var2));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 0x000004b3: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_BOOL(&var2) = -1;
				VariantChangeType(&var2, (index > 0) ? &pDispParams->rgvarg[--index] : &var2, 0, VT_BOOL);
				hr = filesys_CopyFolder(iface, V_BSTR(&var0), V_BSTR(&var1), V_BOOL(&var2));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 0x00000460: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_CreateFolder(iface, V_BSTR(&var0), (IFolder**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
		case 0x0000044d: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var2, (index > 0) ? &pDispParams->rgvarg[--index] : &var2, 0, VT_BOOL);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_CreateTextFile(iface, V_BSTR(&var0), V_BOOL(&var1), V_BOOL(&var2), (ITextStream**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
			}
		...
		case 0x0000044c: {
			if (wFlags & DISPATCH_METHOD) {
				...
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_OpenTextFile(iface, V_BSTR(&var0), (IOMode)V_I4(&var1), V_BOOL(&var2), (Tristate)V_I4(&var3), (ITextStream**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
				VariantClear(&var2);
				VariantClear(&var3);
		...
		case 0x00004e20: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var1, (index > 0) ? &pDispParams->rgvarg[--index] : &var1, 0, VT_BOOL);
				V_VT(pVarResult) = VT_DISPATCH;
				hr = filesys_GetStandardStream(iface, (StandardStreamTypes)V_I4(&var0), V_BOOL(&var1), (ITextStream**)&V_DISPATCH(pVarResult));
				VariantClear(&var0);
				VariantClear(&var1);
			}
			break;
		...
		case 0x00004e2a: {
			if (wFlags & DISPATCH_METHOD) {
				...
				VariantChangeType(&var0, &pDispParams->rgvarg[--index], 0, VT_BSTR);
				V_VT(pVarResult) = VT_BSTR;
				hr = filesys_GetFileVersion(iface, V_BSTR(&var0), &V_BSTR(pVarResult));
				VariantClear(&var0);
			}
			break;
		}
	...
	if (hr != S_OK) {
		if (dispIdMember == DISPID_VALUE && wFlags == (DISPATCH_METHOD | DISPATCH_PROPERTYGET)) {
			V_VT(pVarResult) = VT_DISPATCH;
			V_DISPATCH(pVarResult) = (IDispatch*)iface;
			return S_OK;
		}
		else {
			printf("filesys_Invoke, dispId=%d, wFlags=%d, hr=%d\n", dispIdMember, wFlags, hr);
		}
	}
	return hr;
#endif
